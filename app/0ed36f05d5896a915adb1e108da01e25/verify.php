...
$pass=$_POST["Password"];
$sql = "select * from q1users where username='$user' and password='$pass';";
error_log("QUERY:" . $sql);
...
if ($user == "admin") {
    ...
    $hintUrl = "https://drive.google.com/drive/folders/1jcDzo_qg_qF4D-WAMwaXwIksQBWBGzq0?usp=sharing";
    echo "Hints:<br><br>";
    ...
    echo "CREATE TABLE IF NOT EXISTS `q1users` (
  		`username` varchar(30) NOT NULL,
  		`password` varchar(40) DEFAULT NULL,
  		PRIMARY KEY (`username`)
		) ENGINE=InnoDB DEFAULT CHARSET=utf8;<br>";
    echo "INSERT INTO `q1users` VALUES ('aaa', 'xxx'),('admin', 'xxx'),('user', 'xxx'),('hint', 'xxx'),('flag', 'xxx');<br><br><br>";
} 
